...
$filename="../questions/practiceques/ques/ques_".$id."_".$did.".html";

$testfile="../questions/practiceques/testcases/test_".$id."_".$did.".txt";

$outputfile="../questions/practiceques/output/output_".$id."_".$did.".txt";

$answerfile="../questions/practiceques/answerfiles/answer_".$row['studentid']."_".$id."_".$did.".txt";
...
?>
    ...
    <div id="wrapper" style="margin-top:0px;">
        <form id="code" action="process.php" method="post">
            ...
            <textarea cols="110" rows="10" name="input" id="input"><?php $file=fopen($testfile,"r");
            while(!feof($file)){
            echo fgets($file);
            }
            fclose($file);
            ...
            <?php
            echo '<input type="hidden" name="outputfile" id="outputfile" value="'.$outputfile.'">';
            echo '<input type="hidden" name="answerfile" id="answerfile" value="'.$answerfile.'">';
            echo '<input type="hidden" name="questionid" id="questionid" value="'.$id.'">';
            echo '<input type="hidden" name="domainid" id="domainid" value="'.$did.'">';
            ?>
            <div>
