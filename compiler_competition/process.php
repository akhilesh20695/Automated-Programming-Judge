    ...
    if ( $result['error'] == 'OK' ) {
        ...
        if ( $status['error'] == 'OK' ) {
            ...
            if ( $details['error'] == 'OK' ) {
                ...
                $sql="SELECT * from questions_comp where compid='$compid' and questionid='$qid'";
                ...
                $update1=mysql_query("UPDATE result_timed_comp SET answertime='$curdate' where tcompid='$compid' and tsid='$sid'");
                $update=mysql_query("UPDATE result_timed_comp SET points=points+'$marks' where tcompid='$compid' and tsid='$sid'");

                $update=mysql_query("INSERT into answer_comp VALUES('$sid','$compid','$qid')");
