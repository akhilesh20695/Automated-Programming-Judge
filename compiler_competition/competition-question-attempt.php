...
$answerfile="../questions/compques/answerfiles/answer_".$compid."_".$qid.".txt";
...
?>
    ...
    <div id="wrapper" style="margin-top:0px;">
        <form id="code" action="process.php" method="post">
            ...
            echo '<input type="hidden" name="questionid" id="questionid" value="'.$qid.'">';
            echo '<input type="hidden" name="compid" id="compid" value="'.$compid.'">';
            ?>
            <div>
