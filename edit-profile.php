...
<div class="row">
    <div >
       <div class="well profile" name="dpdiv" id="dpdiv">
          ...
          $sql="SELECT * from `student-course` where studentid='$row[studentid]'";
          ...
          <!--Enter the current courses here -->
					<form method="POST" action="update-courses.php" style="left:5%;">
          <?php
...
<div class="container" style="height:100%;">
  <form style="top:0%; left:20%;" method="post" action="edit-profile-script.php">
    <div class="row">
      <h4>Account</h4>
      ...
      <div class="input-group input-group-icon">
        <?php
        echo '<input type="text" placeholder="'.$row['semail'].'" readonly/>';
        ?>
